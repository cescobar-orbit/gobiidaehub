<?php namespace Laravel\Auth\Drivers; use Laravel\Hash, Laravel\Config, Laravel\Log;
...
class Eloquent extends Driver {
	...
	public function attempt($arguments = array())
	{
		...
		/*	foreach(array_except($arguments, array('username')) as $column => $val)
			{
				Log::info("column: ".$column." val: ".$val);
