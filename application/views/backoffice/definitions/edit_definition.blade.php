...
<br/>
<h3>{{ Lang::line('lbl_definitions.definitions')->get($lang) }} &nbsp; <small>{{ Lang::line('lbl_definitions.edit_definition')->get($lang) }}</small></h3>
          ...
          {{ Form::open_for_files('/backoffice/definition/list', 'post', array('id' => 'frm', 'class' => 'form-horizontal well')) }}           
            ...
            <div class="control-group"> 
              <label class="control-label" for="Term">{{ Lang::line('lbl_definitions.term')->get($lang) }}</label>
                <div class="controls">              
				      {{ Form::text('term', $definition->term, array('readonly'=>'true','class' => 'span3','rel'=>'popover')); }}        
