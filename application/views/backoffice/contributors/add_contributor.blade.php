...
<br/>
<h3>{{ Lang::line('lbl_menu.contributors')->get($lang) }} <small>{{ Lang::line('lbl_contributors.create_contributor')->get($lang) }}</small></h3>
               ...
               <tr>
                 <td>
                   <div class="control-group"> 
                      ...
                      <div class="controls">              
				      {{ Form::text('contributorname', $contributor->contributorname, array('class' => 'span10','rel'=>'popover')) }}        
                      </div>
                   </div>
                    <div class="control-group"> 
                 ...
                 <td colspan="100%" align="center">          
                    <table border="0">
                        <tr>
                            <td valign="top">
                              <input type="radio" name="contributortype" id="author" value="A" checked />
                           </td>
                            <td>{{ Form::label('contributor','Author') }}</td>
                            <td>&nbsp;&nbsp;</td>
                            <td valign="top">
                            <input type="radio" name="contributortype" id="sponsor" value="S" />
