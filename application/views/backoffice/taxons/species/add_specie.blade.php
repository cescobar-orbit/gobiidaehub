...
<br/>
<h3>{{ Taxon::find($genusid)->taxonname }} &nbsp; <small>{{ Lang::line('lbl_taxons.create_specie')->get($lang) }}</small></h3>
                 ...
                 <div class="well row-fluid" style="width:90%">
		           <div class="span5">              
		             <div class="control-group"> 
		                ...
		                <div class="controls">              
						      {{ Form::text('taxonname', $specie->taxonname, array('class' => 'span12','rel'=>'popover')); }}        
		                 </div>
		             </div> 
