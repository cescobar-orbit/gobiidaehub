...
<br/><br/>
<?php  echo Form::open('/backoffice/variable/list_variablenames', 'POST', array('id' => 'frm', 'class' => 'form-horizontal well')); ?>
...
$(document).ready(function(e) {
	 ...
	 $('#btn-cancel').click(function(){
		 $('#frm').attr('action',"{{ URL::to('backoffice/variable/list_variablenames') }}");
		 $('#frm').submit();
	 });
	 
	 $('#btn-delete').click(function(){

	   $('#frm').attr('action', "<?php echo URL::to('backoffice/variable/delete_variablename/'.$id); ?>");;
       $('#frm').submit();
	 });
});
</script>
