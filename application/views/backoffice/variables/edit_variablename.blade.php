...
<br/>
<h3>{{ Lang::line('lbl_variables.variablenamecv')->get($lang) }} <small>{{ Lang::line('lbl_variables.edit_term')->get($lang) }}</small></h3>
             ...
             <div class="control-group"> 
              <label class="control-label" for="Term">{{ Lang::line('lbl_variables.term')->get($lang) }}</label>
                <div class="controls">
				      ...
				      {{ Form::text('term', $variablename->term, array('class' => 'span3','rel'=>'popover')) }}
             ...
             <div class="control-group"> 
              <label class="control-label" for="Definition">{{ Lang::line('lbl_variables.definition')->get($lang) }}</label>
                <div class="controls">
				      ...
				      {{ Form::text('definition', $variablename->definition, array('class' => 'span3','rel'=>'popover')) }}
        
                 </div>
             </div> 
             
             {{ Form::hidden('id', $variablename->id); }}
