...
<br/>
<h3>{{ Lang::line('lbl_accounts.roles')->get($lang) }} &nbsp;<small>{{ Lang::line('lbl_accounts.create_role')->get($lang) }}</small></h3>
        ...
        <div class="row-fluid">
         {{ Form::open('/backoffice/account/list_roles', 'post', array('id' => 'frm', 'class' => 'form-horizontal well')) }}        
             ...
             <div class="control-group"> 
                ...
                <div class="controls">            
				      {{ Form::text('rolename', $role->rolename, array('class' => 'span3','rel'=>'popover')) }}
                 </div>
             </div> 
